...
dependencies {
    ...
    implementation(files("../readium/streamer/libs/nanohttpd-master-SNAPSHOT.jar"))
    implementation(files("../readium/streamer/libs/nanohttpd-nanolets-master-SNAPSHOT.jar"))
